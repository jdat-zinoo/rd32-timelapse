...
class PortB {
public:
  typedef IOPin<PortB, 0> pin10;
  typedef IOPin<PortB, 1> pin9;
  typedef IOPin<PortB, 2> pin8;
...
class PortA {
public:
  typedef IOPin<PortA, 0> pin0;
  typedef IOPin<PortA, 1> pin1;
  typedef IOPin<PortA, 2> pin2;
  typedef IOPin<PortA, 3> pin3;
  typedef IOPin<PortA, 4> pin4;
  typedef IOPin<PortA, 5> pin5;
  typedef IOPin<PortA, 6> pin6;
  typedef IOPin<PortA, 7> pin7;
